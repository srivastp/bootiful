...
insert into Article(id, publication_date, publication_time, creation_date_time, title, article_tag) values(4, TO_DATE('28/02/2019', 'DD/MM/YYYY'), TO_DATE('11:00', 'HH24:MI'), TO_DATE('15/03/2018 08:00', 'DD/MM/YYYY HH24:MI'), 'U.S. Vaccination Rollout Gathers Speed, as Threat of Variants Grows', 'Medical');
insert into Article(id, publication_date, publication_time, creation_date_time, title, article_tag) values(5, null, null, TO_DATE('31/03/2018 11:10', 'DD/MM/YYYY HH24:MI'), 'How the Stock Market’s Relentless Rise Saved Companies', 'Business');
